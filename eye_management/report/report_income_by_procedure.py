...
class ReportIncomeByProcedure(models.AbstractModel):
    _name = 'report.eye_management.report_income_by_procedure'
    _description = "Invoice By Procedure Report"

    def get_income_procedure_data(self, start_date, end_date):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        final_records = self.get_income_procedure_data(start_date, end_date)
        return {
            'doc_ids': self.ids,
    ...
    def formatLang(self, value, digits=None, date=False, date_time=False, grouping=True, monetary=False, dp=False, currency_obj=False, lang=False):
        ...
        return super(ReportIncomeByProcedure, self).formatLang(value, digits=digits, date=date, date_time=date_time, grouping=grouping,
